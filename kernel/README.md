...
utilise ni noyau Linux, ni libc de distribution, ni rootfs de distribution.
GRUB le charge avec Multiboot2 et lui transmet le module rootfs MantleOS.
...
`MANTLE_GRAPHICS_OK` uniquement après un rendu framebuffer réussi. Elle installe
les segments ring 3, le TSS, une pile syscall séparée, le chargeur ELF64 et
l'espace utilisateur mappé avec NX.
